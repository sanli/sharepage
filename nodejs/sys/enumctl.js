...
exports.bindurl=function(app){
    ...
    //动态文件
    share.bindurl(app, '/sys/enum.html', { outType : 'page'}, exports.page);
    share.bindurl(app, '/sys/enum/create', exports.create);
    share.bindurl(app, '/sys/enum/update', exports.update);
    share.bindurl(app, '/sys/enum/list', exports.list);

    share.bindurl(app, '/sys/enum/listnavi', exports.listnavi);

    share.bindurl(app, '/sys/enum/get', exports.get);
    share.bindurl(app, '/sys/enum/retriveByCond', exports.retriveByCond);
    share.bindurl(app, '/sys/enum/delete', exports.delete);
    share.bindurl(app, '/sys/enum/count', exports.count);

    share.bindurl(app, '/sys/enum/import', exports.import);
    share.bindurl(app, '/sys/enum/templ', exports.templ);


    share.bindurl(app, '/sys/enum/export', exports.export);

    share.bindurl(app, '/sys/enum/dlg/:dlgfile', { outType : 'page'}, exports.dlg);
    //TODO: 扩展的API加在下面
    // ...
}
