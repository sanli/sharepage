...
exports.bindurl=function(app){
    ...
    //动态文件
    share.bindurl(app, '/role.html', { outType : 'page'}, exports.page);
    share.bindurl(app, '/role/create', exports.create);
    share.bindurl(app, '/role/update', exports.update);
    share.bindurl(app, '/role/list', exports.list);
    share.bindurl(app, '/role/get', exports.get);
    share.bindurl(app, '/role/retriveByCond', exports.retriveByCond);
    share.bindurl(app, '/role/delete', exports.delete);
    share.bindurl(app, '/role/count', exports.count);


    share.bindurl(app, '/role/dlg/:dlgfile', { outType : 'page'}, exports.dlg);
    //TODO: 扩展的API加在下面
    // ...
}
