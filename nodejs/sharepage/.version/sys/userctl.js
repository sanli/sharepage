//#!本文件由share.js自动产生, 命令行为: node share.js gen user
/**
 * userHTTP入口模块, 需要在主文件中添加map
 * var user = require('./routes/user').bindurl(app);
 */
'use strict';
...
exports.bindurl=function(app){
    //动态文件
    share.bindurl(app, '/user.html', { outType : 'page'}, exports.page);
    share.bindurl(app, '/user/create', exports.create);
    share.bindurl(app, '/user/update', exports.update);
    share.bindurl(app, '/user/list', exports.list);
    share.bindurl(app, '/user/get', exports.retrive);
    share.bindurl(app, '/user/retriveByCond', exports.retriveByCond);
    share.bindurl(app, '/user/delete', exports.delete);
    share.bindurl(app, '/user/count', exports.count);


    share.bindurl(app, '/user/dlg/:dlgfile', { outType : 'page'}, exports.dlg);
    //TODO: 扩展的API加在下面
    // ...
}
...
exports.create = function(req, res){
    ...
    userdb.create(arg.data, function(err, newDoc){
...
exports.update = function(req, res){
    ...
    var data = arg.data;
    delete data._id;
    userdb.update( arg._id , data , function(err, cnt){
        if(err) {
            console.log(err);
...
exports.list = function(req, res){
    ...
    userdb.list(arg.cond, arg.sort, page, function(err, docs){
...
exports.count = function(req, res){
    ...
    share.searchCondExp(arg.cond);
    share.fillUserDataRule(arg.cond, req);
    userdb.count(arg.cond, function(err, count){
        if(err) return share.rt(false, err.message, res);
...
exports.get = function(req, res){
    ...
    userdb.findById(arg._id, function(err, doc){
...
exports.retriveByCond = function(req, res){ 
    ...
    userdb.findByCond(arg.cond, function(err, doc){
        if(err) return share.rt(false, `查询${module_desc}出错:` + err.message, res);
...
exports.delete = function(req, res){
    ...
    userdb.delete(arg._id , function(err, doc){
